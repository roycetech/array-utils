...
public class ArrayUtilsTest {
	...
	public static Collection<Parameter> generateParameters()
	{
		...
		params.add(new Parameter(new Object[][] { { 1, 2 }, { 'a', 'b' } }, "[1, a][1, b][2, a][2, b]"));

		params.add(new Parameter(
				new Object[][] { new String[] { "red", "green", "blue" }, new Integer[] { 1, 2, 3, 4 },
...
class Parameter {
	...
	public String toString()
	{
		...
		if (getInput() == null) {
			...
			retval.append(": Scenario: ").append(Arrays.deepToString(getInput()));
		}
